...
import {Novo,Top,TopEng,Stephen,do40,Popularna,Za500,NovoIzdBooks,TiktokHit2,TiktokHit1,HarryPotterItems1,HarryPotterItems2,HarryPotterItems3} from '../Components/data'
...
const AllProizvodi = () => {
    ...
    const allBooks = [...HarryPotterItems1,...HarryPotterItems2,...HarryPotterItems3,...Novo, ...Top, ...TopEng, ...Stephen, ...do40, ...Popularna, ...Za500,...NovoIzdBooks,...TiktokHit2,...TiktokHit1];
